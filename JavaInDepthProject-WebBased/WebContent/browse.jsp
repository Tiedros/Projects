...
<title>tiedros book store</title>
</head>
<body style="font-family:Arial;font-size:20px;">
	<div style="height:65px;align: center;background: #DB5227;font-family: Arial;color: white;"">
		<br><b>
		<a href="" style="font-family:garamond;font-size:34px;margin:0px 0px 0px 10px;color:white;text-decoration: none;">tiedros's book store</a></b>
		<div style="height:40px;background: #DB5227;font-family: Arial;color: white;">
			<b>
