...
public class UserResource {
	...
	public ResponseEntity newUserPost(
		...
		LOG.info("******** IN Side Method {} ********","newUserPost");
	...
	public ResponseEntity forgetPasswordPost(
		...
		LOG.info("******** IN Side Method {} ********","forgetPasswordPost");
		...
		SimpleMailMessage simpleMailMessage= mailConstructor.constructNewUserEmail(user,password);
