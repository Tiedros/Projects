...
public class UserShipping implements Serializable {
	...
	private Boolean userShipingDefault;
	...
	public Boolean getUserShipingDefault() {
		return userShipingDefault;
	}

	public void setUserShipingDefault(Boolean userShipingDefault) {
		this.userShipingDefault = userShipingDefault;
	}
